        ...
        private async Task SetBlogPic(Blog blog, IFormFile Image)
        {
            if (Image is not null)
            {
                if (blog.BlogImage is null)
                {
                    ...
                    string Imagepath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/BlogImage/", blog.BlogImage);
                ...
                else
                {
                    ...
                    DeleteDemoPath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/BlogImage/", blog.BlogImage);
