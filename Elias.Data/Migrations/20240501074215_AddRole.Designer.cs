...
namespace Elias.Data.Migrations
{
    ...
    [Migration("20240501074215_AddRole")]
            ...
            modelBuilder.Entity("Elias.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 5, 1, 12, 12, 12, 274, DateTimeKind.Local).AddTicks(459),
                            RoleTitle = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Elias.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BirthDay = "1362/06/30",
                            City = "نیشابور",
                            CreateDate = new DateTime(2024, 5, 1, 12, 12, 12, 274, DateTimeKind.Local).AddTicks(548),
